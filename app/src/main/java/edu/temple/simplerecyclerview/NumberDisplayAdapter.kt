...
class NumberDisplayAdapter (private val numbers: Array<Int>, _callback: (Int) -> Unit) : RecyclerView.Adapter<NumberDisplayAdapter.NumberViewHolder>() /* Step 3a: Provide Adapter Parent */ {
